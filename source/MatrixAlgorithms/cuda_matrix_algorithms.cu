...
bool gpu_matrix_algorithm_runner(Matrix *matrix1, Matrix *matrix2,
                                 Matrix *result,
                                 void (*kernel)(DEVICE_MATRIX, DEVICE_MATRIX,
                                                DEVICE_MATRIX, int),
...
extern "C" bool matrix_addition_gpu_single_core(Matrix *matrix1,
                                                Matrix *matrix2,
                                                Matrix *result) {
    return gpu_matrix_algorithm_runner(
        matrix1, matrix2, result, &(matrix_addition_gpu_single_core_kernel), 1,
        1);
}
...
bool matrix_addition_gpu_multi_core(Matrix *matrix1, Matrix *matrix2,
    ...
    success = gpu_matrix_algorithm_runner(
        matrix1, matrix2, result, &(matrix_addition_gpu_multi_core_kernel),
