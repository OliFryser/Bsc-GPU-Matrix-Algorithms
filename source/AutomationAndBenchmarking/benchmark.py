...
algorithms = ["addition cpu", "addition gpu single core", "multiplication cpu", "multiplication gpu single core"] #, "addition gpu multi core", "addition gpu multi core 2"] # "multiplication", "inverse"]
